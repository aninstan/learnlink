import pygame, sys
from settings import HEIGHT, HEIGHT, ground_space
from world import World

pygame.init()

screen = pygame.display.set_mode((HEIGHT, HEIGHT + ground_space))
...
class Main: 
    def __init__(self, screen):
        ...
        self.bg_img = pygame.transform.scale(self.bg_img, (HEIGHT, HEIGHT))
    ...
    def main(self):
        ...
        while True:
            self.stop_ground_scroll = world.game_over #stopper scroll om spillet er ferdig
